...
// Generate random questions
    ...
    function generateFirstRandomAnswer($correct_answer) {
        do {
            $randNum = rand(($correct_answer - 5), ($correct_answer + 5));
        } while ($randNum == $correct_answer);

        return $randNum;
    }

    // generates random answers within + or - 5 of correct answer, and ensure they aren't same as correct answer or the first incorrect answer
